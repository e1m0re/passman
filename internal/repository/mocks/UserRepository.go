...
func (_m *UserRepository) AddUser(ctx context.Context, userInfo models.UserInfo) (*models.User, error) {
...
func (_m *UserRepository) FindUserByUsername(ctx context.Context, username string) (*models.User, error) {
